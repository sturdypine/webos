...
public class ChinaCalendar
{
	 ...
	 * @return
	 */
	public ChinaCalendar(long t)
	{
		int monCyl;// , yearCyl, dayCyl;
		int leapMonth = 0;
		Date baseDate = null;
		try
		{
		...
		// 求出和1900年1月31日相差的天数
		int offset = (int) ((t - baseDate.getTime()) / 86400000L);
		// dayCyl = offset + 40;
		monCyl = 14;
	 ...
	 * today.setTime(chineseDateFormat.parse("2006年12月1日")); ChinaCalendar lunar
	 * = new ChinaCalendar(today.getTimeInMillis());
	 * 
