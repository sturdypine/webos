...
public class MasterSlaveJedisShardInfo extends ShardInfo<MasterSlaveJedis>
{
	...
	public MasterSlaveJedisShardInfo(String masterName, JedisShardInfo masterShard,
			List<JedisShardInfo> slaveShards)
	{
		this(masterName, masterShard, slaveShards, Sharded.DEFAULT_WEIGHT);
	}

	public MasterSlaveJedisShardInfo(String masterName, JedisShardInfo masterShard,
			List<JedisShardInfo> slaveShards, int weight)
	{
		this(masterName, masterShard, slaveShards, Sharded.DEFAULT_WEIGHT, null);
	}

	public MasterSlaveJedisShardInfo(String masterName, JedisShardInfo masterShard,
			List<JedisShardInfo> slaveShards, int weight, String name)
	{
		super(weight);
	...
	public String toString()
	{
		...
		sb.append("{masterName=" + masterName + ", master=" + masterShard.getHost() + ":"
				+ masterShard.getPort() + ", slaves=");
		sb.append("[");
